                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab-standart">
                                                <div id="tabs-standart">
                                                    <ul class="nav nav-tabs">
                                                        <li><a href="#tab-clone" data-toggle="pill"><i class="fa fa-clone"></i>
                                                                <?php echo $head_clone; ?> </a></li>
                                                        <li class="active"><a href="#tab-unit" data-toggle="pill"><i class="fa fa-barcode"></i>
                                                                <?php echo $label_unit; ?> </a></li>
                                                    </ul>
                                                    <div class="tab-content">
                                                                ...
                                                                <table class="table table-bordered">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <div>
                                                                                    <label class="control-label" for="unit_id"><span data-toggle="tooltip" title="<?php echo $help_unit; ?>"><?php echo $label_unit; ?></span></label>
                                                                            ...
                                                                            <td>
                                                                                <div class="btn-group-vertical" role="group" aria-label="Unit tools">
                                                                                    <button type="button" id="unit-edit" class="btn btn-primary"><i class="fa fa-pencil"></i></button>
                                                                                    <button type="button" id="unit-add" class="btn btn-success"><i class="fa fa-plus-circle"></i></button>
                                                                                    <button type="button" id="unit-delete" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="ajax-loader"><img class="loader-img" src="view/javascript/fancytree/skin-win7/loading.gif" style="display:none;" /></div>
